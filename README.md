...
Ainda não existem embeddings, reranker, question decomposition, agregação factual cross-source ou synthesis. O Answer Contract v1 permanece estritamente single-source e não arbitra fontes; a camada Complete da 9A apenas persiste identidade, membership e lifecycle estrutural. Anexos I/II não são parseados por falta de formato físico oficial confirmado no repositório.

Próxima subfase: 9B — agregação determinística cross-source. Synthesis permanece reservada à 9C.
